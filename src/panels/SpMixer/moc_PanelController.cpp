...
struct qt_meta_stringdata_SpMixerController_t {
    QByteArrayData data[3];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SpMixerController_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SpMixerController_t qt_meta_stringdata_SpMixerController = {
    {
QT_MOC_LITERAL(0, 0, 17), // "SpMixerController"
QT_MOC_LITERAL(1, 18, 11), // "probeLevels"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "SpMixerController\0probeLevels\0"
};
...
const QMetaObject SpMixerController::staticMetaObject = {
    { &SPad::staticMetaObject, qt_meta_stringdata_SpMixerController.data,
      qt_meta_data_SpMixerController,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SpMixerController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SpMixerController.stringdata0))
