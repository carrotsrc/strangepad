...
static const char qt_meta_stringdata_SButton[] = {
    "SButton\0"
};
...
const QMetaObjectExtraData SButton::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_SButton,
      qt_meta_data_SButton, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SButton::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SButton))
